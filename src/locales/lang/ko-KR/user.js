export default {
  ...
  'user.login.userid.placeholder': 'Account: admin',
  'user.login.password.placeholder': 'password: qwer1234!',
  'user.login.message-invalid-credentials': '아이디 또는 비밀번호가 틀렸습니다.（admin/qwer1234!）',
  'user.login.message-invalid-verification-code': 'Invalid verification code',
  'user.login.tab-login-credentials': '로그인',
  ...
  'user.login.remember-me': '기억하기',
  'user.login.forgot-password': '비밀번호를 잃어버리셨나요?',
